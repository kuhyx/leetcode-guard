...
LeetCode submission is one credit; one gated day costs one credit on a
Tuesday, Wednesday or Thursday and two on the other days (Monday and Friday
joined the doubled days on 2026-09-21). ``available = sum(credits) -
sum(charges)``, always
